function []=extract_traj_task2()
%extracts individual trajectories for each dimension from AnDi datasets
%for task2
stri=pwd;
source_id=pwd; %source file location
dest_id = strcat(stri,'/Datafiles/Task2/'); %destination folder
fname='task2'; 
